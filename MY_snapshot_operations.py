...
def setup_args():
    ...
    parser.add_argument('-v', '--vmname', required=True,
                        help="Flag to indicate the name of the VM")
    # NEW
...
#inputs = {'vcenter_ip': 'gsx-0001vmm.server-login.com',
#          'vcenter_password': 'cho5ieY7ied{',
#          'vcenter_user': 'server-login\justin.wilson',
#          'vm_name': 'int-1.ezyreg.com',
#          # operation in 'create/remove/revert/
#          # list_all/list_current/remove_all'
#          'operation': 'create',
#          'snapshot_name': 'test-pyvmomi-snap1',
#          'ignore_ssl': True
#          }
